# Social media copy — EWA simulator (ewademo.genesee.coop)

All posts drive to **ewademo.genesee.coop**. Voice: plain-spoken, a little angry on
the member's behalf, never preachy. No real money moves — it's an educational demo.

---

## Instagram — Carousel (use carousel-1.png → carousel-2.png → carousel-3.png)
...
💚 Brought to you by Genesee Co-op Federal Credit Union — because there's a
better way to handle a short week.

#EarnedWageAccess #PaydayLoans #FinancialWellness #CreditUnion #MoneyTips
#PersonalFinance #PredatoryLending #Rochester #FinancialLiteracy #DebtFree

---

## Instagram — Reel / Story (use ig-story.mp4)

**Caption:**

I clicked "get my pay early" so you don't have to. 👀 Watch what the app
*actually* does — the countdowns, the guilt-trip "tips," the surprise
membership — and what it really costs by the end. 😬

Play it yourself (no real money, promise): ewademo.genesee.coop 🔗

#EarnedWageAccess #Dave #EarnIn #DailyPay #MoneyTok #FinancialWellness
#CreditUnion #PersonalFinance

**Story stickers / text overlay ideas:**
- Add a "Link" sticker → ewademo.genesee.coop
- Poll sticker: "Have you ever used a pay-advance app?" Yes / No
- Question sticker: "Want us to break down YOUR app?"
...
the trap is designed. No real money changes hands.

👉 Try it: https://ewademo.genesee.coop

If a short week has you reaching for one of these apps, talk to us first. A credit
union line of credit can cost a fraction of what these apps extract over a year.

— Genesee Co-op Federal Credit Union

---

## Facebook — Carousel / link post (use the 3 carousel images)
...
alternative would have saved you.

👉 https://ewademo.genesee.coop
...
| `feed-square.png` | 1080×1080 | Facebook single-image post |
